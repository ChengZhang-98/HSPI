...
from .utils import block, q_clamp, unblock
...
def _block_log_quantize(
    ...
    per_block_bias = q_clamp(2**exponent_bits - 1 - per_block_max_exponent, 0, 2**exponent_bias_width - 1)
